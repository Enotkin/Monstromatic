...
public partial class EncounterCustomHeader : UserControl
{
    ...
    public static readonly StyledProperty<ICommand> DecreaseLevelCommandProperty =
        AvaloniaProperty.Register<EncounterCustomHeader, ICommand>(nameof(DecreaseLevelCommand));
    ...
    public static readonly StyledProperty<ICommand> IncreaseLevelCommandProperty =
        AvaloniaProperty.Register<EncounterCustomHeader, ICommand>(nameof(IncreaseLevelCommand));
    ...
    public static readonly StyledProperty<ICommand> CloseButtonCommandProperty =
        AvaloniaProperty.Register<EncounterCustomHeader, ICommand>(nameof(CloseButtonCommand));
    ...
    public static readonly StyledProperty<string> MonsterNameProperty =
        AvaloniaProperty.Register<EncounterCustomHeader, string>(nameof(MonsterName));
    ...
    public static readonly StyledProperty<int> MonsterLevelProperty =
        AvaloniaProperty.Register<EncounterCustomHeader, int>(nameof(MonsterLevel));
    ...
    public static readonly StyledProperty<bool> IsColorSelectorVisibleProperty =
        AvaloniaProperty.Register<EncounterCustomHeader, bool>(nameof(IsColorSelectorVisible), true);
